...
public class lessStrictStarDetectionTest {
...
//        Graph<Long, String, String> graph = Graph.fromTupleDataSet(vertexTuples, edgeTuples, env);
        ...
        DataSet<Tuple3<Long, Long, String>> edgesTuple = env.readCsvFile("resources/just1000coma.csv").types(Long.class, Long.class, String.class);
...
//        3.# of edges = # of Vertices – 1.
        ...
        DataSet<Tuple2<Long, LongValue>> sortedDegs = vertexDegrees.sortPartition(1, Order.DESCENDING).setParallelism(1).first(10);
        sortedDegs.print();
//        vertexDegrees.print();
...
//    public static class tenHighestDeg implements FlatMapFunction<Tuple2<Long, LongValue>, LongValue> {
//        Long max;
//        int toCollect;
//
//        public tenHighestDeg(Long M) {
//            this.max = M;
//            this.toCollect = 10;
//        }
//
